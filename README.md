...
Это форк. Поверхность — **90 тулз**, переписанных ради честного ответа, а не широты: запись
...
| `project_query_asset_uuid` | uuid ассета по db://-адресу |
| `project_query_asset_url` | db://-адрес по uuid ассета |
