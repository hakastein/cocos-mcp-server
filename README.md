...
| `component_remove_missing_scripts` | Снять компоненты, чей скрипт удалён из проекта: вердикт даёт база ассетов, а не вид компонента; по умолчанию только отчёт |
